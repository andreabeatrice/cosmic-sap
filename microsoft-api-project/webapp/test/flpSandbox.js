		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#microsoftapiproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"microsoftapiproject-display": {
								"semanticObject": "microsoftapiproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=microsoftapiproject",
									"url": sap.ui.require.toUrl("microsoftapiproject")
								}
							}
						}
					}
